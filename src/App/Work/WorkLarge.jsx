...
const WorkLarge = ({ mainTitle, coverImg, projectTalk, clickFunction }) => {
  const divRef = useRef();
  ...
  return (
    <>
      <motion.div
        ...
        className="flex relative overflow-hidden flex-col  before:w-full before:bg-slate-900 before:opacity-70 before:h-[40%] group lg:w-[70%] md:w-[80%] phone:w-[90%] h-[20rem] rounded-3xl before:hover:opacity-90 before:transition-all before:duration-300 before:ease-in-out before:bottom-0 before:absolute before:z-[2] phone:mx-auto lg:mx-0"
      >
        <img
        ...
        <div className="absolute z-[3] bottom-0 w-full h-[40%] px-3 py-2">
          ...
          <div className="text-white flex w-full justify-between">
            ...
            <button
              ...
              className="px-6 py-1 bg-white text-pink-500 rounded-xl font-extrabold h-max "
            >
              Check
            </button>
          </div>
